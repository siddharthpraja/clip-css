...
/* 3d Mockup  */
.soda {
  background: var(--url), url(/front.png) 0 0;
  background-size: auto 100%;
  width: 150px;
  aspect-ratio: 6/12;
  background-blend-mode: multiply;
  scale: 0.8;
  mask-image: url(/front.png);
  mask-size: auto 100%;
}

.soda:hover {
  background: var(--url2), url(/front.png) 0 0;
  background-size: auto 100%;
  aspect-ratio: 6/12;
  scale: 1;
  background-blend-mode: multiply;
    ...
    <div className="flex flex-col justify-center items-center gap-10 mb-10">
      ...
      <div className="lg:w-2/3">
        <div className="p-4">
          ...
          <code className="text-blue-500">components/Products.tsx</code> file:
          <h1 className="">
            <CopyButton code={themeTogglecode} />
          </h1>
          <p className="text-sm text-red-500">replace the images </p>
        </div>
        <div className="p-4">
