...
import Fifth from "@/components/Hero/Hero5";
...
const Fifth = () => {
  ...
  return (
    <div
      className={\`flex md:flex-col items-center justify-center overflow-hidden h-screen relative bg-\${slides[currentSlide].bgColor} transition-all duration-700\`}
    >
    ...
    <div className="flex flex-col justify-center items-center gap-10 mb-10">
      ...
      <div className="w-2/3 mt-8">
        ...
        <div className="p-4">
          ...
          <h1 className="">
            download the Images form the following links:{" "}
            <a
              href="https://www.figma.com/design/E064dBE4BY6LA5OJm8ofIZ/Slick-Cars-Hero-Animation-%F0%9F%8F%8E%EF%B8%8F%E2%9C%A8-(Community)?node-id=1-85&node-type=frame&t=5cCVsftemFxxU7MK-0"
              className="text-orange-500 underline"
            >
              Thank you @ayzz.thedesigner
            </a>
            <p className="text-red-500  mt-4  font-semibold">ClientSide</p>
          </h1>
        </div>
      </div>
    </div>
