    ...
    <div className="w-11/12 mx-auto flex my-4 flex-col-reverse overflow-hidden   lg:flex-row-reverse gap-5">
      ...
      <div className="xl:w-1/3 lg:w-1/2">
        ...
        <div className="w-full h-[60vh] relative  rounded-3xl">
          ...
          {/* Glass Shadow */}
          <div className="p-4 text-black dark:text-white w-2/3   bg-white/40 dark:bg-black/40 backdrop-blur-sm onload  rounded-xl absolute bottom-8  right-4">
          ...
          <div className="py-2 px-5 font-semibold text-xs flex lg:flex-col xl:flex-row justify-center gap-2 items-center text-black dark:text-white w-full rounded-full absolute top-6 right-1">
            <div className="flex items-center justify-center gap-1 bg-white/80 dark:bg-black/50 backdrop-blur-sm onload  rounded-full p-2">
              <div className="w-3 h-3 blur-sm rounded-full  bg-green-300" />
              <p className="w-max">Zoom Lens</p>
            </div>
            <div className="flex items-center justify-center gap-1 bg-white/50 dark:bg-black/50 backdrop-blur-sm onload rounded-full p-2">
      ...
      <div className="w-full h-[80vh] overflow-hidden relative rounded-3xl">
        ...
        <div className="">
          ...
          {/* Glass Shadow */}
          <div className="p-4 text-white w-56  bg-white/20 backdrop-blur-sm onload rounded-xl absolute top-28 md:right-28 lg:right-4 right-4 xl:right-28">
            <div className="flex justify-between items-start">
          ...
          <div className="py-2 px-5  text-xs flex flex-col xl:flex-row justify-center gap-2 items-end text-white w-full   rounded-full absolute md:bottom-6 bottom-16 right-2">
            <div className="flex items-center justify-center gap-2 bg-white/30 backdrop-blur-sm onload  rounded-full p-2">
              <div className="w-3 h-3  blur-sm rounded-full  bg-green-300" />
